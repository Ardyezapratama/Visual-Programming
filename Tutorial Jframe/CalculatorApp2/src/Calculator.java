...
public class Calculator extends javax.swing.JFrame {
    ...
    public void arithmetic_operation(){
        switch(calculation){
            case 1:
                ans = num + Double.parseDouble(JText1.getText());
                JText1.setText(Double.toString(ans));
                break;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        num = Double.parseDouble(JText1.getText());
        calculation = 1;
        JText1.setText("");
        jLabel1.setText(num + " +");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int length = JText1.getText().length();
        int numb = JText1.getText().length() - 1;
        String store;
        
        if(length > 0){
            StringBuilder back = new StringBuilder(JText1.getText());
